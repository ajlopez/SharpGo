namespace SharpGo.Core.Compiler
{
    ...
    public class Parser
    {
        private static Dictionary<string, TypeInfo> types = new Dictionary<string, TypeInfo>() { { "int32", TypeInfo.Int32 }, { "int16", TypeInfo.Int16 }, { "int64", TypeInfo.Int64 }, { "float32", TypeInfo.Float32 }, { "real64", TypeInfo.Real64 }, { "string", TypeInfo.String }, { "bool", TypeInfo.Bool }, { "nil", TypeInfo.Nil } };
