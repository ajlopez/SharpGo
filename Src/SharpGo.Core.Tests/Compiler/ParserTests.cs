namespace SharpGo.Core.Tests.Compiler
{
    ...
    public class ParserTests
    {
        ...
        public void ParseUnaryPlusVariable()
        {
            ...
            Assert.AreEqual(UnaryOperator.Plus, unode.Operator);
        ...
        [TestMethod]
        public void ParseUnaryMinusVariable()
        {
            Parser parser = new Parser("-a");
            ...
            Assert.AreEqual(UnaryOperator.Minus, unode.Operator);
            Assert.IsNotNull(unode.ExpressionNode);
            Assert.IsInstanceOfType(unode.ExpressionNode, typeof(NameNode));
            Assert.AreEqual("a", ((NameNode)unode.ExpressionNode).Name);
        ...
        [TestMethod]
        public void ParsePointerVariable()
        {
            Parser parser = new Parser("*a");
            ...
            Assert.AreEqual(UnaryOperator.Pointer, unode.Operator);
            Assert.IsNotNull(unode.ExpressionNode);
            Assert.IsInstanceOfType(unode.ExpressionNode, typeof(NameNode));
            Assert.AreEqual("a", ((NameNode)unode.ExpressionNode).Name);
        ...
        public void ParsePreIncrementVariable()
        {
            ...
            Assert.AreEqual(UnaryOperator.Increment, unode.Operator);
            Assert.IsNotNull(unode.ExpressionNode);
            Assert.IsInstanceOfType(unode.ExpressionNode, typeof(NameNode));
            Assert.AreEqual("a", ((NameNode)unode.ExpressionNode).Name);
        ...
        [TestMethod]
        public void ParsePostIncrementVariable()
        {
            Parser parser = new Parser("a++");
        ...
        public void ParsePreDecrementVariable()
        {
            ...
            Assert.AreEqual(UnaryOperator.Decrement, unode.Operator);
            Assert.IsNotNull(unode.ExpressionNode);
            Assert.IsInstanceOfType(unode.ExpressionNode, typeof(NameNode));
            Assert.AreEqual("a", ((NameNode)unode.ExpressionNode).Name);
        ...
        [TestMethod]
        public void ParsePostDecrementVariable()
        {
            Parser parser = new Parser("a--");
        ...
        public void ParseNegateVariable()
        {
            ...
            Assert.AreEqual(UnaryOperator.Negate, unode.Operator);
            Assert.IsNotNull(unode.ExpressionNode);
            Assert.IsInstanceOfType(unode.ExpressionNode, typeof(NameNode));
            Assert.AreEqual("a", ((NameNode)unode.ExpressionNode).Name);
        ...
        [TestMethod]
        public void ParseShortVarDeclarationWithArrayTypeInfoAndListExpression()
        {
            Parser parser = new Parser("foo := [2]int { 1, 2 }");
            ...
            var ati = (ArrayTypeInfo)((VarNode)node).TypeInfo;
        ...
        [TestMethod]
        public void ParseShortVarDeclarationWithArrayTypeInfoImplicitLengthAndListExpression()
        {
            Parser parser = new Parser("foo := [...]int { 1, 2 }");
        ...
        [TestMethod]
        public void ParseSimpleForWithEmptySemicolonAndPostCommand()
        {
            Parser parser = new Parser("for ;x < 1; x = x + 1 {\n x = 1;\n }");
        ...
        [TestMethod]
        public void ParseForWithInitAndNoPostStatements()
        {
            Parser parser = new Parser("for x := 1; x < 10; { \n y = 1;\n }");
