namespace SharpGo.Core.Tests.Compiler
{
    ...
    public class LexerTests
    {
        ...
        public void GetHexadecimalIntegerWithMixedLettersAndDigits()
        {
            ...
            Assert.IsNotNull(token);
            Assert.AreEqual(TokenType.Integer, token.Type);
            Assert.AreEqual("0xBadFace42", token.Value);
        ...
        [TestMethod]
        public void GetTripleDotAsDelimiter()
        {
            Lexer lexer = new Lexer("...");
        ...
        [TestMethod]
        public void GetStringWithDoubleQuote()
        {
            Lexer lexer = new Lexer("\"foo\\\"bar\"");
        ...
        [TestMethod]
        public void GetStringWithBackSlash()
        {
            Lexer lexer = new Lexer("\"foo\\\\bar\"");
